    ...
    async def completion(self, text: str, interaction_count: int, role: str = 'user', name: str = 'user'):
        try:
            ...
            enhanced_system_message = (
                ...
                "For appointments:\n"
                "1. When user confirms date and time AND confirms their WhatsApp number, you MUST send the confirmation using [send_whatsapp()]\n"
                "2. The WhatsApp message MUST be sent BEFORE saying you sent it\n"
                "3. NEVER say you sent a message unless you actually called [send_whatsapp()]\n"
                "4. Use this exact format for appointment confirmations:\n"
